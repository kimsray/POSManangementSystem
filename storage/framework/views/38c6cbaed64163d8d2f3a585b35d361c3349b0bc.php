        ...
        <form action="" method="post" class="form-horizontal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="telephone" class="col-lg-2 col-lg-offset-1 control-label">Telephone</label>
                        <div class="col-lg-6">
...
</div><?php /**PATH C:\xampp\htdocs\PointofSale-Laravel\resources\views/member/form.blade.php ENDPATH**/ ?>