            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="nama" class="col-lg-2 col-lg-offset-1 control-label">Name</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="alamat" class="col-lg-2 col-lg-offset-1 control-label">Address</label>
                        <div class="col-lg-6">
...
</div><?php /**PATH E:\codeastro\Laravel\PointofSale-Laravel\resources\views/supplier/form.blade.php ENDPATH**/ ?>