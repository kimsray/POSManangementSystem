<header class="main-header">
    ...
    <a href="index2.html" class="logo">
        ...
        <!-- <span class="logo-mini">POS System</span> -->
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="<?php echo e(route('user.profil')); ?>" class="btn btn-primary btn-flat">My Profile</a>
                            </div>
...
<form action="<?php echo e(route('logout')); ?>" method="post" id="logout-form" style="display: none;">
    <?php echo csrf_field(); ?>
</form><?php /**PATH C:\xampp\htdocs\PointofSale-Laravel\resources\views/layouts/header.blade.php ENDPATH**/ ?>