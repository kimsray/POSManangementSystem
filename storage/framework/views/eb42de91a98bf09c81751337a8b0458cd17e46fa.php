...
<head>
    ...
    <title><?php echo e($setting ? $setting->name_company : ''); ?> | <?php echo $__env->yieldContent('title'); ?></title>
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
    <!-- Tell the browser to be responsive to screen width -->
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">

    <link rel="icon" href="<?php echo e($setting ? url($setting->path_logo) : url('/')); ?>" type="image/png">
...
<?php /**PATH C:\xampp\htdocs\PointofSale-Laravel\resources\views/layouts/master.blade.php ENDPATH**/ ?>