    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                <button onclick="addForm('<?php echo e(route('pengeluaran.store')); ?>')" class="btn btn-success btn-flat"><i class="fa fa-plus-circle"></i> New Expenses Entry</button>
            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\codeastro\Laravel\PointofSale-Laravel\resources\views/pengeluaran/index.blade.php ENDPATH**/ ?>